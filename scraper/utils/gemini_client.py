...
- "notes" — диапазоны дат («с 12 февраля по 11 июня»), особые пометки («чётные недели», «только сессия»). Если ничего — "".
- Если в ячейке написано «Фамилия И.О. (ауд. NNN)» — это teacher + room в одной строке, разбери оба поля.
- Если время написано как «09:00-10:30» или «09:00» — это time_start/time_end, а не subject.
- Коды групп (например: БZО23-ИСТ2101, ЗОС40-ОАД2502) оставляй как есть, это официальные названия.
