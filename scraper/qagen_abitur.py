...
_JUDGE_SYSTEM_HEADER = (
    ...
    "- FORMAT: markdown (**, #, ```) или битые HTML-теги. Теги <b>…</b> и <i>…</i> "
    "РАЗРЕШЕНЫ и нарушением НЕ являются;\n"
...
def main() -> int:
    ...
    client = _client()
    # судья сверяет с тем же основанием, что видит бот: база + каталог + справочники
