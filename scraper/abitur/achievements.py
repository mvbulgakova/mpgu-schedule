...
# Олимпиады с шкалой 10/5 (п. 8–10, 18–24 Прил. 2): рег. этап ВсОШ, перечневые
# (если не использованы как особое право БВИ/100 баллов), моск. предпроф. конкурсы.
OLYMPIAD = {"winner": ("Победитель олимпиады/конкурса (10/5)", 10),
            "prizer": ("Призёр олимпиады/конкурса (10/5)", 5)}

# Внутренние олимпиады/конкурсы МПГУ и педагогические конкурсы (Прил. 3, п. 25 Прил. 2):
# шкала 10/8/6/4, на профильные направления.
MPGU_CONTEST = {
    "winner": ("Победитель конкурса/олимпиады МПГУ", 10),
    "prizer2": ("Призёр II степени конкурса МПГУ", 8),
    "prizer3": ("Призёр III степени конкурса МПГУ", 6),
    "participant": ("Участник конкурса МПГУ (если предусмотрено)", 4),
}
